...
func ReadJSONResponsePointer[T any](response *http.Response, expectedStatusCode int) (*T, error) {
	data, err := ReadJSONResponseValue[T](response, expectedStatusCode)
	if err != nil {
		return nil, err
	}
	return &data, nil
...
func ReadJSONResponseValue[T any](response *http.Response, expectedStatusCode int) (T, error) {
	var data T
...
func ReadErrorResponse(response *http.Response, expectedStatusCode int) error {
	if response.StatusCode != expectedStatusCode {
